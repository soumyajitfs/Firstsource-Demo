...
import {
  mockExtractedData,
  mockExtractedDataCHK002,
  mockReturnedChecks
} from '../data/mockData'

const StopPaymentProviderDetails = () => {
  ...
  const extractedData =
    selectedCheck.id === 'CHK002' ? mockExtractedDataCHK002 : mockExtractedData
...
export default StopPaymentProviderDetails
